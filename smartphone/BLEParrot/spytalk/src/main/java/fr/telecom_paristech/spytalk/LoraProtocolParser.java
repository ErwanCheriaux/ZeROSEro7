...
public class LoraProtocolParser {
    ...
    public LoraMessage parseMessage(byte[] blePacket) {
        ...
        if (!(Arrays.equals(payload, SpyTalkConnectedActivity.ACKNOWLEDGE_MESSAGE)
                || Arrays.equals(payload, SpyTalkConnectedActivity.TX_FAILED_MESSAGE)
                || senderAddress == LogInActivity.YELLOW_ADDR)) { // Messages generated by the spy talk, hence not encrypted.
            try {
