...
void uart_service_init() {
    ...
    ble_characteristic_config.conn_handle = BLE_CONN_HANDLE_INVALID;
    ...
    err_code = sd_ble_gatts_service_add(BLE_GATTS_SRVC_TYPE_PRIMARY, &ms_uuid,
                                        &ble_characteristic_config.service_handle);
    APP_ERROR_CHECK(err_code);
    ...
    // UUID
    ble_uuid_t ble_uuid;
    ble_uuid.type = ble_characteristic_config.uuid_type;
