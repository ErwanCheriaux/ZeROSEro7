...
/*
 * This file is a copy from  ChibiOS/testhal/STM32/STM32F4xx/USB_CDC_IAD/ directory example.
 */
...
#define CDC_IF_DESC_SET(comIfNum, datIfNum, comInEp, datOutEp, datInEp)                                                 \
    ...
    , /* iInterface.              */                            /* Header Functional Descriptor (CDC section 5.2.3).*/  \
        ...
        USB_DESC_BYTE(datIfNum), /* bDataInterface.          */ /* Abstract Control Management Functional Descriptor.*/ \
        ...
        USB_DESC_BYTE(datIfNum), /* bSlaveInterface.         */ /* Endpoint, Interrupt IN.*/                            \
        USB_DESC_ENDPOINT(                                                                                              \
            comInEp,                                                                                                    \
